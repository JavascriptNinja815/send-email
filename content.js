//default setting
var host = "smtp.elasticemail.com"; //smtp server
var username = "xandokan815@gmail.com"; // username in elasticemail.com
var password = "2f966210-b4f0-4f2f-9d5c-cb21276f918b"; //password in elasticemail.com
var sender = "xandokan815@gmail.com"; //sender email
var subject = "receipt"; //subject
var hidden_div_id = "hidden_email"; //hidden_div_id

function send_email(detected_email) {
  Email.send({
    Host : host,
    Username : username,
    Password : password,
